...
# Create K8S Cluster - soat7myvideo-k8s
...
# Project Myvideo UUID = 1f3e6919-579f-400b-9dab-a6dafaaaafa7
echo "Cluster ID = $DO_CLUSTER_ID"

echo "Assign K8s Cluster (ID=$DO_CLUSTER_ID) with Myvideo Project (ID=$PROJECT_ID)"
